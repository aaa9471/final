...
int GameWindow::process_event()
{
    ...
    player1->position_x = player1->position_x + player1->right * player1->get_speed() - player1->left * player1->get_speed();
    player1->position_y = player1->position_y + player1->down * player1->get_speed() - player1->up * player1->get_speed();
